...
def validate_EIP712Domain_schema(structured_data):
    ...
    validate_field_declared_only_once_in_struct(
        "name", EIP712Domain_data, "EIP712Domain"
    )
    validate_field_declared_only_once_in_struct(
        "version", EIP712Domain_data, "EIP712Domain"
    )
    validate_field_declared_only_once_in_struct(
        "chainId", EIP712Domain_data, "EIP712Domain"
    )
    validate_field_declared_only_once_in_struct(
        "verifyingContract", EIP712Domain_data, "EIP712Domain",
    )
