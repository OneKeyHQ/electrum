...
UIControlState_ALL_RELEVANT_TUPLE = (
...
UIImageRenderingModeAutomatic = (
    0  # Use the default rendering mode for the context where the image is used
)
UIImageRenderingModeAlwaysOriginal = (
    1  # Always draw the original image, without treating it as a template
)
UIImageRenderingModeAlwaysTemplate = (
    2  # Always draw the image as a template image, ignoring its color information
)
...
NSStrokeColorAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSStrokeColorAttributeName")
)
NSStrokeWidthAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSStrokeWidthAttributeName")
)
NSShadowAttributeName = ObjCInstance(c_void_p.in_dll(uikit, "NSShadowAttributeName"))
NSTextEffectAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSTextEffectAttributeName")
)
NSAttachmentAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSAttachmentAttributeName")
)
NSLinkAttributeName = ObjCInstance(c_void_p.in_dll(uikit, "NSLinkAttributeName"))
NSBaselineOffsetAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSBaselineOffsetAttributeName")
)
NSUnderlineColorAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSUnderlineColorAttributeName")
)
NSStrikethroughColorAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSStrikethroughColorAttributeName")
)
NSObliquenessAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSObliquenessAttributeName")
)
NSExpansionAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSExpansionAttributeName")
)
NSWritingDirectionAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSWritingDirectionAttributeName")
)
NSVerticalGlyphFormAttributeName = ObjCInstance(
    c_void_p.in_dll(uikit, "NSVerticalGlyphFormAttributeName")
)
...
UIViewContentModeScaleAspectFit = (
    1  #      // contents scaled to fit with fixed aspect. remainder is transparent
)
UIViewContentModeScaleAspectFill = 2  #     // contents scaled to fill with fixed aspect. some portion of content may be clipped.
UIViewContentModeRedraw = (
    3  #              // redraw on bounds change (calls -setNeedsDisplay)
)
UIViewContentModeCenter = (
    4  #              // contents remain same size. positioned adjusted.
)
...
UIKeyboardTypeDefault = (
    0  #                // Default type for the current input method.
)
UIKeyboardTypeASCIICapable = (
    1  #           // Displays a keyboard which can enter ASCII characters
)
...
UIKeyboardTypePhonePad = (
    5  #               // A phone pad (1-9, *, 0, #, with letters under the numbers).
)
UIKeyboardTypeNamePhonePad = (
    6  #          // A type optimized for entering a person's name or phone number.
)
UIKeyboardTypeEmailAddress = 7  #           // A type optimized for multiple email address entry (shows space @ . prominently).
UIKeyboardTypeDecimalPad = (
    8  # NS_ENUM_AVAILABLE_IOS(4_1),   // A number pad with a decimal point.
)
...
UIKeyboardAppearanceDefault = (
    0  #         // Default apperance for the current input method.
)
...
UIBackgroundRefreshStatusDenied = (
    1  # ,     //< explicitly disabled by the user for this application
)
...
UIApplicationBackgroundFetchIntervalMinimum = c_double.in_dll(
    uikit, "UIApplicationBackgroundFetchIntervalMinimum"
).value
UIApplicationBackgroundFetchIntervalNever = c_double.in_dll(
    uikit, "UIApplicationBackgroundFetchIntervalNever"
).value
...
UIApplicationDidReceiveMemoryWarningNotification = ObjCInstance(
    c_void_p.in_dll(uikit, "UIApplicationDidReceiveMemoryWarningNotification")
)
UIKeyboardWillShowNotification = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardWillShowNotification")
)
UIKeyboardDidShowNotification = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardDidShowNotification")
)
UIKeyboardWillHideNotification = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardWillHideNotification")
)
UIKeyboardDidHideNotification = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardDidHideNotification")
)
UIKeyboardFrameBeginUserInfoKey = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardFrameBeginUserInfoKey")
)  # NSValue of CGRect
UIKeyboardFrameEndUserInfoKey = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardFrameEndUserInfoKey")
)  # NSValue of CGRect
UIKeyboardAnimationDurationUserInfoKey = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardAnimationDurationUserInfoKey")
)  # NSNumber of double
UIKeyboardAnimationCurveUserInfoKey = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardAnimationCurveUserInfoKey")
)  # NSNumber of NSUInteger (UIViewAnimationCurve)
UIKeyboardIsLocalUserInfoKey = ObjCInstance(
    c_void_p.in_dll(uikit, "UIKeyboardIsLocalUserInfoKey")
)  # NSNumber of BOOL
...
UIDeviceOrientationLandscapeRight = (
    4  # ,      // Device oriented horizontally, home button on the left
)
...
UIUserInterfaceIdiomPhone = (
    0  # NS_ENUM_AVAILABLE_IOS(3_2), // iPhone and iPod touch style UI
)
...
UIActivityTypePostToFacebook = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypePostToFacebook")
)
UIActivityTypePostToTwitter = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypePostToTwitter")
)
UIActivityTypePostToWeibo = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypePostToWeibo")
)
...
UIActivityTypeCopyToPasteboard = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypeCopyToPasteboard")
)
UIActivityTypeAssignToContact = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypeAssignToContact")
)
UIActivityTypeSaveToCameraRoll = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypeSaveToCameraRoll")
)
UIActivityTypeAddToReadingList = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypeAddToReadingList")
)
UIActivityTypePostToFlickr = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypePostToFlickr")
)
UIActivityTypePostToVimeo = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypePostToVimeo")
)
UIActivityTypePostToTencentWeibo = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypePostToTencentWeibo")
)
UIActivityTypeAirDrop = ObjCInstance(c_void_p.in_dll(uikit, "UIActivityTypeAirDrop"))
UIActivityTypeOpenInIBooks = ObjCInstance(
    c_void_p.in_dll(uikit, "UIActivityTypeOpenInIBooks")
)
...
try:
    ...
    print(
        "iOS 11.0+ UI Swipe Action facility missing, exception was:", "[" + str(e) + "]"
    )

CIColor = ObjCClass(
    "CIColor"
)  # be careful using CIColor -- it has been known to not work due to iOS bugs
...
UIPageViewControllerTransitionStylePageCurl = (
    0  # , // Navigate between views via a page curl transition.
)
...
UIBlurEffectStyleExtraDark = (
    3  # __TVOS_AVAILABLE(10_0) __IOS_PROHIBITED __WATCHOS_PROHIBITED,
)
UIBlurEffectStyleRegular = (
    4  # NS_ENUM_AVAILABLE_IOS(10_0), // Adapts to user interface style
)
UIBlurEffectStyleProminent = (
    5  # NS_ENUM_AVAILABLE_IOS(10_0), // Adapts to user interface style
)
