...
from electrum import SimpleConfig, constants, daemon, keystore, util
from electrum.commands import Commands, config_variables, get_parser, known_commands
...
print(
    "before time = %s" % time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))
)
# constants.set_testnet()
constants.set_regtest()
print(
    "after time = %s" % time.strftime("%Y-%m-%d %H:%M:%S", time.localtime(time.time()))
)
...
testcommond.load_all_wallet()
keystore = {
    "address": "ae2425eb0235c2df1ad39d91fc50978edb7bea83",
    "crypto": {
        "cipher": "aes-128-ctr",
        "cipherparams": {"iv": "c46726d14060bec5a7a0c44718cb6ef8"},
        ...
        "kdfparams": {
            ...
            "dklen": 32,
            "prf": "hmac-sha256",
            "salt": "d3e21673bfcc20c3438c00c0200d2eba",
        },
        "mac": "b4e6b735d0fd6ea709cd7ba4c040dbcfe2ad4cafe411dbce0ca2e4eef3c3d701",
    },
    "id": "ee6f2e41-6435-4f14-b3ff-f765804ca872",
    "version": 3,
}
...
add = testcommond.parse_pr(
    "bitcoin:tb1qv9gz5aap7h0qxg00vc239y2al6x6zj6dp7lqqe?time=1586771792&exp=3600"
)
print("addr = %s--------" % add)
# time.sleep(1000)
