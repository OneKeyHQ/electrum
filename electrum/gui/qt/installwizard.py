...
from PyQt5.QtCore import QEventLoop, QRect, Qt, pyqtSignal
from PyQt5.QtGui import QPainter, QPalette, QPen, QPixmap
...
from electrum.plugin import Plugins, run_hook
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def seed_input(self, title, message, is_seed, options):
        slayout = SeedLayout(
            title=message, is_seed=is_seed, options=options, parent=self
        )
        self.exec_layout(slayout, title, next_enabled=False)
