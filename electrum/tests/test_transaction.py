...
class TestTransaction(ElectrumTestCase):
    ...
    def test_tx_setting_version_invalidates_ser_cache(self):
        ...
        tx.version = 555
        self.assertEqual(
            "8a9b89a1a7aac1995dd013069d9866197d77c14c22315958d612fc02fd4b596a",
            tx.txid(),
        )
    ...
    def test_estimated_output_size(self):
        ...
        self.assertEqual(
            estimated_output_size("14gcRovpkCoGkCNBivQBvw7eso7eiNAbxG"), 34
        )
        self.assertEqual(
            estimated_output_size("35ZqQJcBQMZ1rsv8aSuJ2wkC7ohUCQMJbT"), 32
        )
        self.assertEqual(
            estimated_output_size("bc1q3g5tmkmlvxryhh843v4dz026avatc0zzr6h3af"), 31
        )
        self.assertEqual(
    ...
    def test_get_address_from_output_script(self):
        ...
        self.assertEqual(
            None, addr_from_script("0013751e76e8199196d454941c45d1b3a323f1433b")
        )
        ...
        # almost but not quite
        self.assertEqual(
            None, addr_from_script("76a9130000000000000000000000000000000000000088ac")
        )
        ...
        # almost but not quite
        self.assertEqual(
            None, addr_from_script("a912f47c8954e421031ad04ecd8e7752c947920687")
        )
