...
class TestDnsSec(ElectrumTestCase):
    def test_python_validate_rrsig_ecdsa(self):
        ...
        rrsig = dns.rdtypes.ANY.RRSIG.RRSIG.from_text(
            ...
            dns.tokenizer.Tokenizer(
                "DNSKEY 13 2 3600 20180612115508 20180413115508 2371 getmonero.org. SSjtP2jCtXPukps7E3kum709xq2TH6Lt Ur32UhE7WKwSUfLTZ4EAoD5g22mi1fpB GDGb30kCMndDVjnHAEBDWw=="
            ),
        )
        ...
        self.assertEqual(
            None, dnssec.python_validate_rrsig(rrset, rrsig, keys, origin, now)
        )
    ...
    def test_python_validate_rrsig_rsa(self):
        ...
        rrsig = dns.rdtypes.ANY.RRSIG.RRSIG.from_text(
            ...
            46,
            dns.tokenizer.Tokenizer(
                "DS 7 2 86400 20180609010045 20180519000045 1862 org. SgdGsY4BAm7c3qpwzVLy3ua4orvrsJQO 0rUQDDrrXR6lElnbF+AS0gEEfdZfDv11 65AuNil/+kT2Qh/ExgstvhWQ88XdDnHB ouvRMf9pg3p/q5Otet/StRzf33SMPgC1 zLzkfkSBCjJkwVmwde8saGnjdcW522ra Ge/6JcsryRw="
            ),
        )
