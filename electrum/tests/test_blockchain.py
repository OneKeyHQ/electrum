...
from electrum.util import bfh, bh2u, make_dir
...
class TestBlockchain(ElectrumTestCase):
    ...
    def test_forking_and_swapping(self):
        ...
        self.assertEqual(
            os.path.join(self.data_dir, "blockchain_headers"), chain_u.path()
        )
        ...
        self.assertEqual(
            os.path.join(self.data_dir, "blockchain_headers"), chain_l.path()
        )
        ...
        self.assertEqual(
            os.path.join(self.data_dir, "blockchain_headers"), chain_z.path()
        )
    ...
    def test_get_chains_that_contain_header(self):
        ...
        self.assertEqual(
            [chain_l, chain_z],
            self.get_chains_that_contain_header_helper(self.HEADERS["G"]),
        )
        self.assertEqual(
            [chain_l, chain_z],
            self.get_chains_that_contain_header_helper(self.HEADERS["I"]),
        )
        self.assertEqual(
            [chain_z], self.get_chains_that_contain_header_helper(self.HEADERS["M"])
        )
        self.assertEqual(
            [chain_l], self.get_chains_that_contain_header_helper(self.HEADERS["K"])
        )
        ...
        self.assertEqual(
            [chain_u], self.get_chains_that_contain_header_helper(self.HEADERS["O"])
        )
        self.assertEqual(
            [chain_z, chain_l],
            self.get_chains_that_contain_header_helper(self.HEADERS["I"]),
